...
- Clone the repo: `git clone https://gitlab.network18tech.com/Network18-Election-Framework/electionv4cms.git`
...
│   ├── hooks/       # common hooks
│   ├── modules/     # modules - authModule, layoutModule - _nav.tsx sidebar navigation
│   ├── navigation/  # navigation - AuthRouter, AppRouter routes.ts config
│   ├── redux/       # redux store
│   ├── scss/        # scss styles
│   ├── utils/       # common utils
...
├── staging.env      # staging env config
├── ...
