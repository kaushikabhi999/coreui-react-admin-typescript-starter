...
const CandidateResult = React.lazy(() => import('../views/pages/candidate-result/CandidateResult'))

const routes = [
  { path: '/', exact: true, name: 'States' },
  ...
  { path: '/election/candidate-result', name: 'Candidate Result', element: CandidateResult },
]
